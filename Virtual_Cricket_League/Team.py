...
class Team:
    ...
    def __str__(self):
        return self.name
# team1_data = {'name': 'Warriors', 'players': [{'name': 'Rohit Sharma', 'age': 31, 'playertype': 'batsman', 'battinghand': 'right', 'bowlingtype': 'right arm off spin', 'experience': 87, 'batskill': 89, 'bowlskill': 52, 'wktskill': 23, 'battingorder': '[90, 85, 80, 70, 50, 50, 50, 50, 50, 50, 50]', 'bowlingorder': ['midover'], 'batcomfort': ['fast', 'right'], 'bowlcomfort': ['left']}, {'name': 'Hardik Pandya', 'age': 26, 'playertype': 'allrounder', 'battinghand': 'right', 'bowlingtype': 'right arm seam', 'experience': 81, 'batskill': 82, 'bowlskill': 76, 'wktskill': 21, 'battingorder': '[50, 50, 50, 50, 80, 80, 90, 50, 50, 50, 50]', 'bowlingorder': ['midover', 'deathover'], 'batcomfort': ['fast', 'spin', 'right'], 'bowlcomfort': ['right']}, {'name': 'Jasprit Bumrah', 'age': 27, 'playertype': 'bowler', 'battinghand': 'right', 'bowlingtype': 'right arm fast', 'experience': 85, 'batskill': 33, 'bowlskill': 91, 'wktskill': 0, 'battingorder': '[10, 10, 10, 10, 10, 10, 10, 10, 20, 20, 20]', 'bowlingorder': ['powerplay', 'midover', 'deathover'], 'batcomfort': ['spin'], 'bowlcomfort': ['right', 'left']}, 
# {'name': 'KL Rahul', 'age': 29, 'playertype': 'wicketkeeperbatsman', 'battinghand': 'right', 'bowlingtype': 'None', 'experience': 81, 'batskill': 86, 'bowlskill': 12, 'wktskill': 83, 'battingorder': '[85, 85, 85, 80, 50, 50, 50, 50, 50, 50, 50]', 'bowlingorder': ['midover'], 'batcomfort': ['fast', 'seam', 'right'], 'bowlcomfort': ['right']}, {'name': 'Kuldeep Yadav', 'age': 28, 'playertype': 'bowler', 'battinghand': 'left', 'bowlingtype': 'left arm leg spin', 'experience': 81, 'batskill': 34, 'bowlskill': 86, 'wktskill': 12, 'battingorder': '[40, 40, 40, 40, 40, 40, 40, 40, 70, 70, 70]', 'bowlingorder': ['midover'], 'batcomfort': ['fast'], 'bowlcomfort': ['right']}, {'name': 'Mayank Agarwal', 'age': 28, 'playertype': 'batsman', 'battinghand': 'right', 'bowlingtype': 'right arm off spin', 'experience': 78, 'batskill': 83, 'bowlskill': 36, 'wktskill': 36, 'battingorder': '[80, 90, 80, 80, 80, 50, 50, 50, 50, 50, 50]', 'bowlingorder': ['midover'], 'batcomfort': ['fast', 'spin', 
# 'right'], 'bowlcomfort': ['left']}, {'name': 'Ravindra Jadeja', 'age': 32, 'playertype': 'allrounder', 'battinghand': 'left', 'bowlingtype': 'left arm off spin', 'experience': 86, 'batskill': 79, 'bowlskill': 83, 'wktskill': 26, 'battingorder': '[50, 50, 50, 50, 80, 90, 90, 80, 50, 50, 50]', 'bowlingorder': ['powerplay', 'midover', 'deathover'], 'batcomfort': ['fast', 'right'], 'bowlcomfort': ['right', 'left']}, {'name': 'Ishant Sharma', 'age': 31, 'playertype': 'bowler', 'battinghand': 'right', 'bowlingtype': 'right arm fast', 'experience': 84, 'batskill': 23, 'bowlskill': 86, 'wktskill': 0, 'battingorder': '[30, 30, 30, 30, 30, 30, 30, 30, 40, 40, 40]', 'bowlingorder': ['powerplay', 'midover'], 'batcomfort': ['right'], 'bowlcomfort': ['right', 'left']}, {'name': 'Rishabh Pant', 'age': 28, 'playertype': 'wicketkeeperbatsman', 'battinghand': 'left', 'bowlingtype': 'None', 'experience': 77, 'batskill': 74, 'bowlskill': 0, 'wktskill': 78, 'battingorder': '[50, 50, 50, 80, 80, 80, 50, 50, 50, 50, 50]', 'bowlingorder': ['midover'], 'batcomfort': ['seam', 'spin', 'right'], 'bowlcomfort': 
# ['left']}, {'name': 'Shikhar Dhawan', 'age': 32, 'playertype': 'batsman', 'battinghand': 'left', 'bowlingtype': 'None', 'experience': 81, 'batskill': 81, 'bowlskill': 11, 'wktskill': 9, 'battingorder': '[45, 45, 60, 70, 85, 90, 50, 50, 50, 50, 50]', 'bowlingorder': ['midover'], 'batcomfort': ['fast', 'seam', 'right'], 'bowlcomfort': ['right']}, {'name': 'Shubman Gill', 'age': 22, 'playertype': 'batsman', 'battinghand': 'right', 'bowlingtype': 'None', 'experience': 76, 'batskill': 79, 'bowlskill': 12, 'wktskill': 23, 'battingorder': '[70, 70, 85, 80, 70, 70, 50, 50, 50, 50, 50]', 'bowlingorder': ['powerplay'], 'batcomfort': ['fast', 'spin', 'right'], 'bowlcomfort': ['right', 'left']}], 'captain': {'name': 'Rohit Sharma', 'age': 31, 'playertype': 'batsman', 'battinghand': 'right', 'bowlingtype': 'right arm off spin', 'experience': 87, 'batskill': 89, 'bowlskill': 52, 'wktskill': 23, 'battingorder': '[90, 85, 80, 70, 50, 50, 50, 50, 50, 50, 50]', 'bowlingorder': ['midover'], 'batcomfort': ['fast', 'right'], 'bowlcomfort': ['left']}, 'wktkeeper': {'name': 'Rishabh Pant', 'age': 28, 'playertype': 'wicketkeeperbatsman', 'battinghand': 'left', 'bowlingtype': 'None', 'experience': 77, 'batskill': 74, 'bowlskill': 0, 'wktskill': 78, 'battingorder': '[50, 50, 50, 80, 80, 80, 50, 50, 50, 50, 50]', 'bowlingorder': ['midover'], 'batcomfort': ['seam', 'spin', 'right'], 'bowlcomfort': ['left']}, 'homeground': {'name': 'Wankhede, Mumbai', 'weather': 'hot', 'pitch': 'green', 'field': 'moregrass'}}
# t1 = Team(team1_data)
# ct = 0
# for i in t1.bowlingLineup:
#     ct += 1
#     print(ct, i.name)
# bowlinglineup = ['Jasprit Bumrah', 'Hardik Pandya','Kuldeep Yadav','Ravindra Jadeja','Ishant Sharma','Jasprit Bumrah','Hardik Pandya','Kuldeep Yadav','Ravindra Jadeja','Ishant Sharma','Jasprit Bumrah','Hardik Pandya','Kuldeep Yadav','Ravindra Jadeja','Ishant Sharma','Jasprit Bumrah','Hardik Pandya','Kuldeep Yadav','Ravindra Jadeja','Ishant Sharma']